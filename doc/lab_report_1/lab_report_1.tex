...
\vskip 0.3 cm
\begin{center}
\centering { \includegraphics[scale=0.60]{res/pdf/general-fsm-crop.pdf} }
\end{center}
...
\vskip 0.3 cm
\begin{center}
\centering { \includegraphics[scale=0.60]{res/pdf/stateswitcher-fsm-crop.pdf} \par }
\end{center}
...
\vskip 0.3 cm
\begin{center}
\centering { \includegraphics[scale=0.65]{res/pdf/timer-fsm-crop.pdf} \par }
\end{center}
